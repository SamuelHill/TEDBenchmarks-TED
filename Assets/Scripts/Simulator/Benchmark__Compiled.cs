...
namespace Scripts.Simulator {
    ...
    [CompiledHelpersFor("Benchmark")] public class Benchmark__Compiled : TED.Compiler.CompiledTEDProgram {
        ...
        public override void Link(TED.Program program) {
            ...
            Affinity__1 = (GeneralIndex<ValueTuple<Person, Person, float>, Person>)Affinity.IndexFor(1);
            Affinity__0 = (GeneralIndex<ValueTuple<Person, Person, float>, Person>)Affinity.IndexFor(0);
        ...
        public static GeneralIndex<ValueTuple<Person, Person, float>, Person> Affinity__1;
        public static GeneralIndex<ValueTuple<Person, Person, float>, Person> Affinity__0;
